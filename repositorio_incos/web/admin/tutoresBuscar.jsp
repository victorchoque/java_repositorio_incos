...
<h1>Lista tutores</h1>
<form method="get">
    <input type="text" name="buscar" value="<%=request.getParameter("buscar")==null? "":request.getParameter("buscar")%>"/>
...
<%for (Tutor item : tutorBean.buscarTutores(request.getParameter("buscar")) ) {%>
    <tr>
        <td><%=item.getId()%></td>
